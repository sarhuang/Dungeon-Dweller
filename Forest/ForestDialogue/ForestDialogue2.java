/**
 * Program: ForesDialogue2.java
 * 
 * Name: Sarah Huang
 * 
 * Purpose: Dialogue in forest #2
 * 
...
public class ForestDialogue2 extends World
{
    private GreenfootImage slimeRight = new GreenfootImage("CROP_green_right1.png");
    
    public ForestDialogue2()    //SARAH - Displays black background with dialogue and slime.
    {    
        super(1080, 580, 1); 
    ...
    {
        if (Greenfoot.isKeyDown("enter")) Greenfoot.setWorld(new ForestDialogue3());
    }
}
